<<<<<<<< HEAD:tests/ecom-checkout.spec.ts
// Moved to tests/ui/ecom-checkout.spec.ts
export {};
========
...
>>>>>>>> 749ae4e (Reorganize project structure: move pages, add API tests and skills):tests/ui/ecom-checkout.spec.ts
